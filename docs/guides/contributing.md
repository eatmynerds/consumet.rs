...
- Fixing [known bugs](https://github.com/consumet-rs/consumet.rs/issues?q=is%3Aissue+is%3Aopen+label%3ABug)
...
## How To Contribute
If you'd like to contribute, start by searching through the [issues](https://github.com/consumet-rs/consumet.rs/issues) and [pull requests](https://github.com/consumet-rs/consumet.rs/pulls) to see whether someone else has raised a similar idea or question.
