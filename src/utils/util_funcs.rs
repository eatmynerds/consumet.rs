...
/// ```
/// use consumet_rs::utils::util_funcs::USER_AGENT;
...
pub trait UtilFuncs {
    ...
    /// ```
    /// use consumet_rs::utils::util_funcs::UtilFuncs;
    ///
...
/// ```
/// use consumet_rs::utils::util_funcs::{get_days, Days};
///
...
/// ```
/// use consumet_rs::utils::util_funcs::convert_duration;
///
